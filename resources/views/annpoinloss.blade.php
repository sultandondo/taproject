            ...
            <form method="POST" action="{{ route('annpoinloss.store', ['id' => $dataId]) }}" id="antennaForm_poin">
                ...
                <div class="bg-blue-50 p-6 rounded-lg border border-blue-200 shadow-sm mb-6">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-with-unit-wrapper">
                            <input type="number" name="wavelength_upgrounds_poin" id="wavelength_upgrounds_poin" class="border border-gray-300 p-3 w-full rounded bg-gray-50" min="0" step="0.001" readonly value="">
                ...
                <div class="bg-blue-50 p-6 rounded-lg border border-blue-200 shadow-sm mb-6">
                    ...
                    <div class="mb-4">
                        <label class="block font-medium mb-1 text-gray-700">Panjang Gelombang (λ) (m):</label>
                        <div class="input-with-unit-wrapper">
                            <input type="number" name="wavelength_downgrounds_poin" id="wavelength_downgrounds_poin" class="border border-gray-300 p-3 w-full rounded bg-gray-50" min="0" step="0.001" readonly value="">
                            <span class="unit-text">m</span>
                        </div>
    ...
    <script>
        ...
        function calculateRollOff(section) {
            ...
            if (section === 'upgrounds') {
                ...
                angleField = document.getElementById('upgrounds_θ4_poin'); // Corrected to θ4 for downlink grounds
        ...
        function calculatePointingLoss(section) {
            ...
            if (section === 'upgrounds') {
                ...
                pointingErrorField = document.getElementById('upgrounds_θ4_poin'); // Corrected to θ4 for downlink grounds
                beamwidthField = document.getElementById('beamwidth_downgrounds_poin');
        ...
        function showPointingLossDetail(section) {
            ...
            document.querySelector('#pointingLossPopup #pointing-loss-popup-content-body .formula').innerHTML = formulaHTML; // Corrected selector
        ...
        function setupEventListeners() {
            ['up', 'down'].forEach(ld => {
                ...
                if (ld === 'up') {
                    ...
                    const pointingErrorGrounds = document.getElementById('upgrounds_θ4_poin'); // Corrected ID
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            ['up', 'down'].forEach(ld => {
                ...
                // Calculate pointing loss for spacecraft on load
                calculatePointingLoss(`${ld}spacecraft`);
            });
            ...
            document.getElementById('antennaForm_poin').addEventListener('submit', function(e) {
                ...
                const requiredFields = [
                    ...
                    'upgrounds_θ4_poin', // Corrected ID
                    'gain_downspacecraft_poin',
                    'beamwidth_downspacecraft_poin',
                    'downspacecraft_θ3_poin', // Corrected ID
                    'calculation_formulas_downspacecraft_poin'
                ];

                requiredFields.forEach(fieldId => {
                    const field = document.getElementById(fieldId);
                    if (!field || field.value === '' || parseFloat(field.value) < 0) { // Check for empty string as well
