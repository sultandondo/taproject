<x-layout>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="tx_powerwatts_up" name="tx_powerwatts_up" class="w-full p-3 border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" placeholder="{{ $data->watt_up ?? '' }}" step="any" value="{{ old('tx_powerwatts_up', $data->watt_up ?? '') }}" readonly>
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="tx_powerdbw_up" name="tx_powerdbw_up" class="w-full p-3 border border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" value="{{ old('tx_powerdbw_up', $data->tx_powerdbw_up ?? '') }}" readonly>
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="tx_powerdbm_up" name="tx_powerdbm_up" class="w-full p-3 border border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" value="{{ old('tx_powerdbm_up', $data->tx_powerdbm_up ?? '') }}" readonly>
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="trlinelosses_up" name="trlinelosses_up" class="w-full p-3 border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" placeholder="{{ $data->totlinelosses_up ?? '' }}" step="any" value="{{ old('trlinelosses_up', $data->totlinelosses_up ?? '') }}" readonly>
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="antennaagain_up" name="antennaagain_up" class="w-full p-3 border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" placeholder="{{ $data->gain_manual_upgrounds ?? '' }}" step="any" value="{{ old('antennaagain_up', $data->gain_manual_upgrounds ?? '') }}" readonly>
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="eirp_up" name="eirp_up" class="w-full p-3 border border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" value="{{ old('eirp_up', $data->eirp_up ?? '') }}" readonly>
                                        <span class="unit-text">dBW</span>
                                    </div>
                                </div>
                                <div class="detail-button-wrapper">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="pointinglosses_up" name="pointinglosses_up" class="w-full p-3 border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" placeholder="{{ $data->approxannpoinloss_upgrounds_poin ?? '' }}" step="any" value="{{ old('pointinglosses_up', $data->approxannpoinloss_upgrounds_poin ?? '') }}" readonly>
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="polarizationlosses_up" name="polarizationlosses_up" class="w-full p-3 border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" placeholder="{{ $data->hasilpolarizationloss_up ?? '' }}" step="any" value="{{ old('polarizationlosses_up', $data->hasilpolarizationloss_up ?? '') }}" readonly>
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="pathlosss_up" name="pathlosss_up" class="w-full p-3 border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" placeholder="{{ $data->path_loss ?? '' }}" step="any" value="{{ old('pathlosss_up', $data->path_loss ?? '') }}" readonly>
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                <div class="detail-button-wrapper">
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="atmosphericlosses_up" name="atmosphericlosses_up" class="w-full p-3 border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" placeholder="{{ $data->uplink_loss_determined_atmospheric ?? '' }}" step="any" value="{{ old('atmosphericlosses_up', $data->uplink_loss_determined_atmospheric ?? '') }}" readonly>
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        ...
                                        placeholder="{{ $data->uplink_loss_ionosphere ?? '' }}" step="any" value="{{ old('ionosphericlosses_up', $data->uplink_loss_ionosphere ?? '') }}" readonly>
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="rainlosses_up" name="rainlosses_up" class="border border-gray-300 p-3 w-full rounded-lg bg-gray-50 shadow-sm focus:ring-2 focus:ring-blue-400 focus:outline-none" placeholder="Enter rain losses" value="{{ old('rainlosses_up', $data->rainlosses_up ?? '') }}">
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="md:col-span-2 lg:col-span-3 relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="signallevel_up" name="signallevel_up" class="w-full p-3 border border-yellow-400 rounded-lg bg-yellow-100 text-yellow-800 cursor-not-allowed font-bold text-lg" value="{{ old('signallevel_up', $data->signallevel_up ?? '') }}" readonly>
                                        <span class="unit-text">dBW</span>
                                    </div>
                                </div>
                                <div class="detail-button-wrapper">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        ...
                                        placeholder="{{ $data->approxannpoinloss_upspacecraft_poin ?? '' }}" step="any" value="{{ old('scpointingloss_up', $data->approxannpoinloss_upspacecraft_poin ?? '') }}" readonly>
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="scantennagain_up" name="scantennagain_up" class="w-full p-3 border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" placeholder="{{ $data->gain_manual_upspacecraft ?? '' }}" step="any" value="{{ old('scantennagain_up', $data->gain_manual_upspacecraft ?? '') }}" readonly>
                                        <span class="unit-text">dBi</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        ...
                                        placeholder="{{ $data->antenna_to_lna_uprec ?? '' }}" step="any" value="{{ old('sclinelosses_up', $data->antenna_to_lna_uprec ?? '') }}" readonly>
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="scnoisetemp_up" name="scnoisetemp_up" class="w-full p-3 border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" placeholder="{{ $data->ts_uprec ?? '' }}" step="any" value="{{ old('scnoisetemp_up', $data->ts_uprec ?? '') }}" readonly>
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="scgtratio_up" name="scgtratio_up" class="w-full p-3 border border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" value="{{ old('scgtratio_up', $data->scgtratio_up ?? '') }}" readonly>
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="scsignalpower_up" name="scsignalpower_up" class="w-full p-3 border border-yellow-400 rounded-lg bg-yellow-100 text-yellow-800 cursor-not-allowed font-bold" value="{{ old('scsignalpower_up', $data->scsignalpower_up ?? '') }}" readonly>
                                        <span class="unit-text">dBW</span>
                                    </div>
                                </div>
                                <div class="detail-button-wrapper">
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="scbandwidth_up" name="scbandwidth_up" class="border border-gray-300 p-3 w-full rounded-lg bg-gray-50 shadow-sm focus:ring-2 focus:ring-blue-400 focus:outline-none" placeholder="Enter receiver bandwidth" value="{{ old('scbandwidth_up', $data->scbandwidth_up ?? '') }}">
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="scnoisepower_up" name="scnoisepower_up" class="w-full p-3 border border-yellow-400 rounded-lg bg-yellow-100 text-yellow-800 cursor-not-allowed font-bold" value="{{ old('scnoisepower_up', $data->scnoisepower_up ?? '') }}" readonly>
                                        <span class="unit-text">dBW</span>
                                    </div>
                                </div>
                                <div class="detail-button-wrapper">
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="snrratio_up" name="snrratio_up" class="w-full p-3 border border-yellow-400 rounded-lg bg-yellow-100 text-yellow-800 cursor-not-allowed font-bold" value="{{ old('snrratio_up', $data->snrratio_up ?? '') }}" readonly>
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                <div class="detail-button-wrapper">
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="requiredsnr_up" name="requiredsnr_up" class="border border-gray-300 p-3 w-full rounded-lg bg-gray-50 shadow-sm focus:ring-2 focus:ring-blue-400 focus:outline-none" placeholder="Enter required S/N" value="{{ old('requiredsnr_up', $data->requiredsnr_up ?? '') }}">
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="md:col-span-2 relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="linkmargin_up" name="linkmargin_up" class="w-full p-3 border border-yellow-400 rounded-lg bg-yellow-100 text-yellow-800 cursor-not-allowed font-bold text-lg" value="{{ old('linkmargin_up', $data->linkmargin_up ?? '') }}" readonly>
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                <div class="detail-button-wrapper">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="sc_powerwatts_down" name="sc_powerwatts_down" class="w-full p-3 border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" placeholder="{{ $data->watt_down ?? '' }}" step="any" value="{{ old('sc_powerwatts_down', $data->watt_down ?? '') }}" readonly>
                                        <span class="unit-text">watts</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="relative form-field">
                                <div>
                                    <label class="block font-medium text-gray-700">Power in dBW:</label>
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="sc_powerdbw_down" name="sc_powerdbw_down" class="w-full p-3 border border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" value="{{ old('sc_powerdbw_down', $data->sc_powerdbw_down ?? '') }}" readonly>
                                        <span class="unit-text">dBW</span>
                                    </div>
                                </div>
                                <div class="detail-button-wrapper">
                            ...
                            <div class="relative form-field">
                                <div>
                                    <label class="block font-medium text-gray-700">Power in dBm:</label>
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="sc_powerdbm_down" name="sc_powerdbm_down" class="w-full p-3 border border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" value="{{ old('sc_powerdbm_down', $data->sc_powerdbm_down ?? '') }}" readonly>
                                        <span class="unit-text">dBm</span>
                                    </div>
                                </div>
                                <div class="detail-button-wrapper">
                            ...
                            <div class="relative form-field">
                                <div>
                                    <label class="block font-medium text-gray-700">Spacecraft Total Transmission Line Losses:</label>
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="sclinelosses_down" name="sclinelosses_down" class="w-full p-3 border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" placeholder="{{ $data->totlinelosses_down ?? '' }}" step="any" value="{{ old('sclinelosses_down', $data->totlinelosses_down ?? '') }}" readonly>
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="relative form-field">
                                <div>
                                    <label class="block font-medium text-gray-700">Spacecraft Antenna Gain:</label>
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="scantennaagain_down" name="scantennaagain_down" class="w-full p-3 border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" placeholder="{{ $data->gain_manual_downspacecraft ?? '' }}" step="any" value="{{ old('scantennaagain_down', $data->gain_manual_downspacecraft ?? '') }}" readonly>
                                        <span class="unit-text">dBi</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="sceirp_down" name="sceirp_down" class="w-full p-3 border border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" value="{{ old('sceirp_down', $data->sceirp_down ?? '') }}" readonly>
                                        <span class="unit-text">dBW</span>
                                    </div>
                                </div>
                                <div class="detail-button-wrapper">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="scpointinglosses_down" name="scpointinglosses_down" class="w-full p-3 border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" placeholder="{{ $data->approxannpoinloss_downspacecraft_poin ?? '' }}" step="any" value="{{ old('scpointinglosses_down', $data->approxannpoinloss_downspacecraft_poin ?? '') }}" readonly>
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="polarizationlosses_down" name="polarizationlosses_down" class="w-full p-3 border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" placeholder="{{ $data->hasilpolarizationloss_down ?? '' }}" step="any" value="{{ old('polarizationlosses_down', $data->hasilpolarizationloss_down ?? '') }}" readonly>
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="relative form-field">
                                <div>
                                    <label class="block font-medium text-gray-700">Path Loss:</label>
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="pathlosss_down" name="pathlosss_down" class="w-full p-3 border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" placeholder="{{ $data->path_loss_downlink ?? '' }}" step="any" value="{{ old('pathlosss_down', $data->path_loss_downlink ?? '') }}" readonly>
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                <div class="detail-button-wrapper">
                            ...
                            <div class="relative form-field">
                                <div>
                                    <label class="block font-medium text-gray-700">Atmospheric Losses:</label>
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="atmosphericlosses_down" name="atmosphericlosses_down" class="w-full p-3 border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" placeholder="{{ $data->downlink_loss_determined_atmospheric ?? '' }}" step="any" value="{{ old('atmosphericlosses_down', $data->downlink_loss_determined_atmospheric ?? '') }}" readonly>
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="relative form-field">
                                <div>
                                    <label class="block font-medium text-gray-700">Ionospheric Losses:</label>
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="ionosphericlosses_down" name="ionosphericlosses_down" class="w-full p-3 border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" placeholder="{{ $data->downlink_loss_ionosphere ?? '' }}" step="any" value="{{ old('ionosphericlosses_down', $data->downlink_loss_ionosphere ?? '') }}" readonly>
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="relative form-field">
                                <div>
                                    <label class="block font-medium text-gray-700">Rain Losses:</label>
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="rainlosses_down" name="rainlosses_down" class="border border-gray-300 p-3 w-full rounded-lg bg-gray-50 shadow-sm focus:ring-2 focus:ring-blue-400 focus:outline-none" placeholder="Enter rain losses" value="{{ old('rainlosses_down', $data->rainlosses_down ?? '') }}">
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="md:col-span-2 lg:col-span-3 relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="signallevel_down" name="signallevel_down" class="w-full p-3 border border-yellow-400 rounded-lg bg-yellow-100 text-yellow-800 cursor-not-allowed font-bold text-lg" value="{{ old('signallevel_down', $data->signallevel_down ?? '') }}" readonly>
                                        <span class="unit-text">dBW</span>
                                    </div>
                                </div>
                                <div class="detail-button-wrapper">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="gspointingloss_down" name="gspointingloss_down" class="w-full p-3 border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" placeholder="{{ $data->approxannpoinloss_downgrounds_poin ?? '' }}" step="any" value="{{ old('gspointingloss_down', $data->approxannpoinloss_downgrounds_poin ?? '') }}" readonly>
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="gsantennagain_down" name="gsantennagain_down" class="w-full p-3 border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" placeholder="{{ $data->gain_manual_downgrounds ?? '' }}" step="any" value="{{ old('gsantennagain_down', $data->gain_manual_downgrounds ?? '') }}" readonly>
                                        <span class="unit-text">dBi</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="gslinelosses_down" name="gslinelosses_down" class="w-full p-3 border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" placeholder="{{ $data->antenna_to_lna_downrec ?? '' }}" step="any" value="{{ old('gslinelosses_down', $data->antenna_to_lna_downrec ?? '') }}" readonly>
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="gsnoisetemp_down" name="gsnoisetemp_down" class="w-full p-3 border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" placeholder="{{ $data->ts_downrec ?? '' }}" step="any" value="{{ old('gsnoisetemp_down', $data->ts_downrec ?? '') }}" readonly>
                                        <span class="unit-text">K</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="gsgtratio_down" name="gsgtratio_down" class="w-full p-3 border border-green-300 rounded-lg bg-green-100 text-green-700 cursor-not-allowed" value="{{ old('gsgtratio_down', $data->gsgtratio_down ?? '') }}" readonly>
                                        <span class="unit-text">dB/K</span>
                                    </div>
                                </div>
                                <div class="detail-button-wrapper">
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="gssignalpower_down" name="gssignalpower_down" class="w-full p-3 border border-yellow-400 rounded-lg bg-yellow-100 text-yellow-800 cursor-not-allowed font-bold" value="{{ old('gssignalpower_down', $data->gssignalpower_down ?? '') }}" readonly>
                                        <span class="unit-text">dBW</span>
                                    </div>
                                </div>
                                <div class="detail-button-wrapper">
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="gsbandwidth_down" name="gsbandwidth_down" class="border border-gray-300 p-3 w-full rounded-lg bg-gray-50 shadow-sm focus:ring-2 focus:ring-blue-400 focus:outline-none" placeholder="Enter receiver bandwidth" value="{{ old('gsbandwidth_down', $data->gsbandwidth_down ?? '') }}">
                                        <span class="unit-text">Hz</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="gsnoisepower_down" name="gsnoisepower_down" class="w-full p-3 border border-yellow-400 rounded-lg bg-yellow-100 text-yellow-800 cursor-not-allowed font-bold" value="{{ old('gsnoisepower_down', $data->gsnoisepower_down ?? '') }}" readonly>
                                        <span class="unit-text">dBW</span>
                                    </div>
                                </div>
                                <div class="detail-button-wrapper">
                            ...
                            <div class="relative form-field">
                                <div>
                                    ...
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="snrratio_down" name="snrratio_down" class="w-full p-3 border border-yellow-400 rounded-lg bg-yellow-100 text-yellow-800 cursor-not-allowed font-bold" value="{{ old('snrratio_down', $data->snrratio_down ?? '') }}" readonly>
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                <div class="detail-button-wrapper">
                            ...
                            <div class="relative form-field">
                                <div>
                                    <label class="block font-medium text-gray-700">Analog or Digital System Required S/N:</label>
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="requiredsnr_down" name="requiredsnr_down" class="border border-gray-300 p-3 w-full rounded-lg bg-gray-50 shadow-sm focus:ring-2 focus:ring-blue-400 focus:outline-none" placeholder="Enter required S/N" value="{{ old('requiredsnr_down', $data->requiredsnr_down ?? '') }}">
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                {{-- Removed info icon button for input --}}
                            ...
                            <div class="md:col-span-2 relative form-field">
                                <div>
                                    <label class="block font-medium text-gray-700">System Link Margin:</label>
                                    <div class="input-with-unit-wrapper">
                                        <input type="number" step="any" id="linkmargin_down" name="linkmargin_down" class="w-full p-3 border border-yellow-400 rounded-lg bg-yellow-100 text-yellow-800 cursor-not-allowed font-bold text-lg" value="{{ old('linkmargin_down', $data->linkmargin_down ?? '') }}" readonly>
                                        <span class="unit-text">dB</span>
                                    </div>
                                </div>
                                <div class="detail-button-wrapper">
       ...
       <div id="popup_tx_powerdbw_up" class="popup-window">
           <div class="popup-content">
               ...
               <div class="popup-body">
                   ...
                   Daya dalam <strong>dBW</strong> (decibel-Watts) adalah satuan logaritmik yang digunakan untuk menyatakan daya sinyal relatif terhadap 1 watt. Ini sering digunakan dalam komunikasi satelit karena memudahkan perhitungan ketika daya sinyal dikalikan atau dibagi (menjadi penjumlahan atau pengurangan dalam skala dB).</p>
           ...
           <div class="popup-content">
               ...
               <div class="popup-body">
                   <div>
                       ...
                       <p><strong>Penjelasan:</strong><br>
                       Daya dalam <strong>dBm</strong> (decibel-milliwatts) adalah satuan logaritmik yang digunakan untuk menyatakan daya sinyal relatif terhadap 1 milliwatt. Ini sering digunakan dalam aplikasi RF berdaya rendah, seperti pada receiver.</p>
                       <p><strong>Sumber:</strong><br>
                       G. Maral and M. Bousquet, "Satellite Communications Systems: Systems, Techniques and Technology," Wiley, latest edition.</p>
                   </div>
               </div>
       ...
       <div id="popup_eirp_up" class="popup-window">
           <div class="popup-content">
               ...
               <div class="popup-body">
                   ...
                   <p><strong>Penjelasan:</strong><br>
                   <strong>EIRP</strong> (Effective Isotropic Radiated Power) adalah ukuran daya yang dipancarkan oleh antena ke arah tertentu, memperhitungkan daya input ke antena dan gain antena. Ini adalah parameter penting untuk menentukan kekuatan sinyal yang sampai ke satelit.</p>
                   <p><strong>Sumber:</strong><br>
                   G. Maral and M. Bousquet, "Satellite Communications Systems: Systems, Techniques and Technology," Wiley, latest edition.</p>
               </div>
           </div>
       ...
       <div id="popup_signallevel_up" class="popup-window">
           <div class="popup-content">
               ...
               <div class="popup-body">
                   <div class="formula">
                       <strong>Rumus Perhitungan:</strong><br>
                       $$P_{sc} = \text{EIRP}_{\text{GS}} - (L_{\text{pointing GS}} + L_{\text{pol}} + L_{\text{path}} + L_{\text{atm}} + L_{\text{ionos}} + L_{\text{rain})}$$
                       Dimana:<br>
                       $P_{sc}$ = Isotropic Signal Level at Spacecraft (dBW)<br>
                       $\text{EIRP}_{\text{GS}}$ = Ground Station EIRP (dBW)<br>
                       $L_{\text{pointing GS}}$ = Ground Station Antenna Pointing Losses (dB)<br>
                   ...
                   <p><strong>Penjelasan:</strong><br>
                   <strong>Level sinyal isotropik di satelit</strong> adalah daya sinyal yang diterima oleh satelit, setelah memperhitungkan semua kerugian yang terjadi di sepanjang jalur uplink. Ini adalah indikator penting dari kekuatan sinyal yang tersedia untuk diproses oleh transponder satelit.</p>
                   <p><strong>Sumber:</strong><br>
                   G. Maral and M. Bousquet, "Satellite Communications Systems: Systems, Techniques and Technology," Wiley, latest edition.</p>
               </div>
           </div>
       ...
       <div id="popup_scgtratio_up" class="popup-window">
           <div class="popup-content">
               ...
               <div class="popup-body">
                   ...
                   <p><strong>Penjelasan:</strong><br>
                   <strong>Figure of Merit (G/T)</strong> adalah ukuran sensitivitas penerima satelit, menunjukkan seberapa baik satelit dapat menerima sinyal. Nilai G/T yang lebih tinggi menunjukkan penerima yang lebih sensitif.</p>
                   <p><strong>Sumber:</strong><br>
                   G. Maral and M. Bousquet, "Satellite Communications Systems: Systems, Techniques and Technology," Wiley, latest edition.</p>
               </div>
           </div>
       ...
       <div id="popup_scsignalpower_up" class="popup-window">
           <div class="popup-content">
               ...
               <div class="popup-body">
                   ...
                   <p><strong>Penjelasan:</strong><br>
                   <strong>Daya sinyal pada input LNA</strong> (Low Noise Amplifier) satelit adalah daya yang diterima oleh bagian pertama dari penerima satelit, setelah dikurangi kerugian penunjukan dan jalur transmisi internal satelit. Ini adalah tingkat sinyal yang relevan untuk perhitungan SNR.</p>
                   <p><strong>Sumber:</strong><br>
                   G. Maral and M. Bousquet, "Satellite Communications Systems: Systems, Techniques and Technology," Wiley, latest edition.</p>
               </div>
           </div>
       ...
       <div id="popup_scnoisepower_up" class="popup-window">
           <div class="popup-content">
               ...
               <div class="popup-body">
                   ...
                   <p><strong>Penjelasan:</strong><br>
                   <strong>Daya derau penerima</strong> adalah daya derau termal yang dihasilkan dalam sistem penerima satelit. Ini merupakan faktor pembatas utama kinerja sistem komunikasi, karena derau bersaing dengan sinyal yang diinginkan.</p>
                   <p><strong>Sumber:</strong><br>
                   G. Maral and M. Bousquet, "Satellite Communications Systems: Systems, Techniques and Technology," Wiley, latest edition.</p>
               </div>
           </div>
       ...
       <div id="popup_snrratio_up" class="popup-window">
           <div class="popup-content">
               ...
               <div class="popup-body">
                   ...
                   <p><strong>Penjelasan:</strong><br>
                   <strong>Rasio sinyal-ke-derau (SNR)</strong> adalah perbandingan antara kekuatan sinyal yang diinginkan dan kekuatan derau latar belakang. Ini adalah metrik kunci untuk kualitas sinyal: SNR yang lebih tinggi berarti sinyal yang lebih jelas dan lebih andal.</p>
                   <p><strong>Sumber:</strong><br>
                   G. Maral and M. Bousquet, "Satellite Communications Systems: Systems, Techniques and Technology," Wiley, latest edition.</p>
               </div>
           </div>
       ...
       <div id="popup_sc_powerdbm_down" class="popup-window">
           <div class="popup-content">
               ...
               <div class="popup-body">
                   ...
                   <p><strong>Penjelasan:</strong><br>
                   Daya dalam <strong>dBm</strong> (decibel-milliwatts) adalah satuan logaritmik yang digunakan untuk menyatakan daya sinyal relatif terhadap 1 milliwatt. Ini sering digunakan dalam aplikasi RF berdaya rendah.</p>
                   <p><strong>Sumber:</strong><br>
                   G. Maral and M. Bousquet, "Satellite Communications Systems: Systems, Techniques and Technology," Wiley, latest edition.</p>
               </div>
           </div>
       ...
       <div id="popup_sceirp_down" class="popup-window">
           <div class="popup-content">
               ...
               <div class="popup-body">
                   ...
                   <p><strong>Penjelasan:</strong><br>
                   <strong>EIRP</strong> (Effective Isotropic Radiated Power) satelit adalah daya yang dipancarkan oleh antena satelit menuju Bumi. Ini adalah parameter penting untuk menentukan kekuatan sinyal yang akan diterima oleh stasiun bumi.</p>
                   <p><strong>Sumber:</strong><br>
                   G. Maral and M. Bousquet, "Satellite Communications Systems: Systems, Techniques and Technology," Wiley, latest edition.</p>
               </div>
           </div>
       ...
       <div id="popup_pathloss_down" class="popup-window">
           <div class="popup-content">
               ...
               <div class="popup-body">
                   ...
                   <p><strong>Penjelasan:</strong><br>
                   <strong>Path Loss</strong> adalah kehilangan daya sinyal saat merambat melalui ruang bebas. Ini adalah kerugian paling signifikan dalam tautan komunikasi satelit dan sangat bergantung pada frekuensi sinyal dan jarak antara pemancar dan penerima. Untuk kalkulator ini, nilai Path Loss dimasukkan secara manual berdasarkan perhitungan terpisah (misalnya, dari kalkulator frekuensi ke path loss).</p>
                   <p><strong>Sumber:</strong><br>
                   G. Maral and M. Bousquet, "Satellite Communications Systems: Systems, Techniques and Technology," Wiley, latest edition.</p>
               </div>
           </div>
       ...
       <div id="popup_signallevel_down" class="popup-window">
           <div class="popup-content">
               ...
               <div class="popup-body">
                   ...
                   <p><strong>Penjelasan:</strong><br>
                   <strong>Level sinyal isotropik di stasiun bumi</strong> adalah daya sinyal yang diterima oleh stasiun bumi, setelah memperhitungkan semua kerugian yang terjadi di sepanjang jalur downlink. Ini adalah indikator penting dari kekuatan sinyal yang tersedia untuk diproses oleh penerima stasiun bumi.</p>
                   <p><strong>Sumber:</strong><br>
                   G. Maral and M. Bousquet, "Satellite Communications Systems: Systems, Techniques and Technology," Wiley, latest edition.</p>
               </div>
           </div>
       ...
       <div id="popup_gsgtratio_down" class="popup-window">
           <div class="popup-content">
               ...
               <div class="popup-body">
                   ...
                   <p><strong>Penjelasan:</strong><br>
                   <strong>Figure of Merit (G/T)</strong> adalah ukuran sensitivitas penerima stasiun bumi, menunjukkan seberapa baik stasiun bumi dapat menerima sinyal dari satelit. Nilai G/T yang lebih tinggi menunjukkan penerima yang lebih sensitif.</p>
                   <p><strong>Sumber:</strong><br>
                   G. Maral and M. Bousquet, "Satellite Communications Systems: Systems, Techniques and Technology," Wiley, latest edition.</p>
               </div>
           </div>
       ...
       <div id="popup_gssignalpower_down" class="popup-window">
           <div class="popup-content">
               ...
               <div class="popup-body">
                   ...
                   <p><strong>Penjelasan:</strong><br>
                   <strong>Daya sinyal pada input LNA</strong> (Low Noise Amplifier) stasiun bumi adalah daya yang diterima oleh bagian pertama dari penerima stasiun bumi, setelah dikurangi kerugian penunjukan dan jalur transmisi internal stasiun bumi. Ini adalah tingkat sinyal yang relevan untuk perhitungan SNR.</p>
                   <p><strong>Sumber:</strong><br>
                   G. Maral and M. Bousquet, "Satellite Communications Systems: Systems, Techniques and Technology," Wiley, latest edition.</p>
               </div>
           </div>
       ...
       <div id="popup_gsnoisepower_down" class="popup-window">
           <div class="popup-content">
               ...
               <div class="popup-body">
                   ...
                   <p><strong>Penjelasan:</strong><br>
                   <strong>Daya derau penerima</strong> adalah daya derau termal yang dihasilkan dalam sistem penerima stasiun bumi. Ini merupakan faktor pembatas utama kinerja sistem komunikasi, karena derau bersaing dengan sinyal yang diinginkan.</p>
                   <p><strong>Sumber:</strong><br>
                   G. Maral and M. Bousquet, "Satellite Communications Systems: Systems, Techniques and Technology," Wiley, latest edition.</p>
               </div>
           </div>
   ...
   <script>
       ...
       function calculateUplinkDownlink() {
           ...
           document.getElementById('tx_powerdbm_up').value = isNaN(txPowerDbmUp) ? '' : txPowerDbmUp.toFixed(1);
           ...
           document.getElementById('eirp_up').value = isNaN(eirpUp) ? '' : eirpUp.toFixed(1);
           ...
           document.getElementById('signallevel_up').value = isNaN(signalLevelUp) ? '' : signalLevelUp.toFixed(1);
           ...
           document.getElementById('scgtratio_up').value = isNaN(scGtratioUp) ? '' : scGtratioUp.toFixed(1);
           ...
           document.getElementById('scsignalpower_up').value = isNaN(scSignalPowerUp) ? '' : scSignalPowerUp.toFixed(1);
           ...
           document.getElementById('scnoisepower_up').value = isNaN(scNoisePowerUp) ? '' : scNoisePowerUp.toFixed(1);
           ...
           document.getElementById('snrratio_up').value = isNaN(snrRatioUp) ? '' : snrRatioUp.toFixed(1);
           ...
           document.getElementById('linkmargin_up').value = isNaN(linkMarginUp) ? '' : linkMarginUp.toFixed(1);
           ...
           document.getElementById('sc_powerdbm_down').value = isNaN(scPowerDbmDown) ? '' : scPowerDbmDown.toFixed(1);
           ...
           document.getElementById('sceirp_down').value = isNaN(sceirpDown) ? '' : sceirpDown.toFixed(1);
           ...
           document.getElementById('gsgtratio_down').value = isNaN(gsGtratioDown) ? '' : gsGtratioDown.toFixed(1);
           ...
           document.getElementById('gssignalpower_down').value = isNaN(gsSignalPowerDown) ? '' : gsSignalPowerDown.toFixed(1);
           ...
           document.getElementById('gsnoisepower_down').value = isNaN(gsNoisePowerDown) ? '' : gsNoisePowerDown.toFixed(2);
           ...
           document.getElementById('snrratio_down').value = isNaN(snrRatioDown) ? '' : snrRatioDown.toFixed(2);
           ...
           document.getElementById('linkmargin_down').value = isNaN(linkMarginDown) ? '' : linkMarginDown.toFixed(2);
       }
       ...
       document.querySelectorAll('input[type="number"]').forEach(input => {
            ...
            input.addEventListener('change', calculateUplinkDownlink);
        });
